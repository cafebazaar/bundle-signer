...
public interface ApkSignerEngine extends Closeable {
    ...
    DigestAlgorithm getV1ContentDigestAlgorithm();
    ...
    Map<ContentDigestAlgorithm, byte[]> getContentDigestsV2V3Cafebazaar(
            DataSource zipEntries,
            DataSource zipCentralDirectory,
            DataSource zipEocd)
            throws IOException, ApkFormatException, NoSuchAlgorithmException,
    ...
    byte[] signContentDigestsV2V3Cafebazaar(
            Map<ContentDigestAlgorithm, byte[]> contentDigests)
            throws IOException, ApkFormatException, NoSuchAlgorithmException,
            InvalidKeyException, SignatureException, IllegalStateException;

    OutputApkSigningBlockRequest2 addSignedContentDigestsV2V3Cafebazaar(
            DataSource zipEntries,
     ...
     */
    interface OutputJarSignatureRequest extends Serializable {
