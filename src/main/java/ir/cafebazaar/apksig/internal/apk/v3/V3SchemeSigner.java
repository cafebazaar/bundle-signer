...
package ir.cafebazaar.apksig.internal.apk.v3;

import static ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.encodeAsLengthPrefixedElement;
import static ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.encodeAsSequenceOfLengthPrefixedElements;
import static ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.encodeAsSequenceOfLengthPrefixedPairsOfIntAndLengthPrefixedBytes;
import static ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.encodeCertificates;
import static ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.encodePublicKey;

import ir.cafebazaar.apksig.SigningCertificateLineage;
import ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils;
import ir.cafebazaar.apksig.internal.apk.ApkSigningBlockUtils.SignerConfig;
...
public abstract class V3SchemeSigner {
    ...
    public static ApkSigningBlockUtils.SigningSchemeBlockAndDigests
            generateApkSignatureSchemeV3BlockCafebazaar(
                    Map<ContentDigestAlgorithm, byte[]> contentDigests,
                    List<SignerConfig> signerConfigs)
                    throws InvalidKeyException, NoSuchAlgorithmException, SignatureException {
        return new ApkSigningBlockUtils.SigningSchemeBlockAndDigests(
                generateApkSignatureSchemeV3Block(signerConfigs, contentDigests),
                contentDigests);
    }
