...
package ir.cafebazaar.apksig.internal.apk;

import static ir.cafebazaar.apksig.internal.apk.ContentDigestAlgorithm.CHUNKED_SHA256;
import static ir.cafebazaar.apksig.internal.apk.ContentDigestAlgorithm.CHUNKED_SHA512;
import static ir.cafebazaar.apksig.internal.apk.ContentDigestAlgorithm.VERITY_CHUNKED_SHA256;

import ir.cafebazaar.apksig.ApkVerifier;
import ir.cafebazaar.apksig.SigningCertificateLineage;
import ir.cafebazaar.apksig.apk.ApkFormatException;
import ir.cafebazaar.apksig.apk.ApkUtils;
import ir.cafebazaar.apksig.internal.asn1.Asn1BerParser;
import ir.cafebazaar.apksig.internal.asn1.Asn1DecodingException;
import ir.cafebazaar.apksig.internal.asn1.Asn1DerEncoder;
import ir.cafebazaar.apksig.internal.asn1.Asn1EncodingException;
import ir.cafebazaar.apksig.internal.asn1.Asn1OpaqueObject;
import ir.cafebazaar.apksig.internal.pkcs7.AlgorithmIdentifier;
import ir.cafebazaar.apksig.internal.pkcs7.ContentInfo;
import ir.cafebazaar.apksig.internal.pkcs7.EncapsulatedContentInfo;
import ir.cafebazaar.apksig.internal.pkcs7.IssuerAndSerialNumber;
import ir.cafebazaar.apksig.internal.pkcs7.Pkcs7Constants;
import ir.cafebazaar.apksig.internal.pkcs7.SignedData;
import ir.cafebazaar.apksig.internal.pkcs7.SignerIdentifier;
import ir.cafebazaar.apksig.internal.pkcs7.SignerInfo;
import ir.cafebazaar.apksig.internal.util.ByteBufferDataSource;
import ir.cafebazaar.apksig.internal.util.ChainedDataSource;
import ir.cafebazaar.apksig.internal.util.Pair;
import ir.cafebazaar.apksig.internal.util.VerityTreeBuilder;
import ir.cafebazaar.apksig.internal.x509.RSAPublicKey;
import ir.cafebazaar.apksig.internal.x509.SubjectPublicKeyInfo;
...
public class ApkSigningBlockUtils {
    ...
    public static ByteBuffer findApkSignatureSchemeBlock(
        ...
        } catch (ir.cafebazaar.apksig.internal.apk.SignatureNotFoundException e) {
    ...
    public static Map<ContentDigestAlgorithm, byte[]>
            computeContentDigestsCafebazaar(
                    RunnablesExecutor executor,
                    DataSource beforeCentralDir,
                    DataSource centralDir,
                    DataSource eocd)
        ...
        // Here we add all possible content digests algorithms.
        Set<ContentDigestAlgorithm> contentDigestAlgorithms = new HashSet<>();
        contentDigestAlgorithms.add(ContentDigestAlgorithm.CHUNKED_SHA256);
        contentDigestAlgorithms.add(ContentDigestAlgorithm.CHUNKED_SHA512);
        contentDigestAlgorithms.add(ContentDigestAlgorithm.VERITY_CHUNKED_SHA256);
